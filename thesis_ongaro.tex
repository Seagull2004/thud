...
Ogni metrica porterà alla definizione di un certo $t_m$, tale risultato deriva dal calcolo dei diversi \textit{threshold} $t_i$ ottenuti dalle diverse telecamere.
